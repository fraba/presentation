...
date: "3rd Social Conflict and Political Economy (SCoPE) Workshop<br>University of Sydney, 31 March - 1 April 2026"
format:
  revealjs:
    self-contained: true
    fig-format: retina
...
![Geographic and temporal distribution of homicides in Mexico](fig/fig-1.jpg)

::: aside
300,000+ murders in past decade | 23.3 deaths/100,000 | 30% of territory under cartel control
:::
...
![Overview of data collection pipeline and methods](fig/fig-2.svg)

## Data Collection Pipeline

![Data collection and processing workflow](fig/fig-4.jpg)
...
![Distribution of videos and comments over time](fig/fig-3.jpg)
...
![VPI, ACLED, and Homicides geographic distributions](fig/fig-6.svg)
...
::: {layout-ncol=2}
![Residual analysis by marginalization level](fig/fig-7.jpg)

![Spatial distribution of residuals](fig/fig-8.svg)
:::
...
![VPI and ACLED temporal comparison](fig/fig-5.svg)
